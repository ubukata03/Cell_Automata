...
//１からのターン
setSeed(10+x, 5+b, { beadType: 200, index: -3, bondNum: 1 });
setSeed(11+x, 5+b, { beadType: 201, index: -3, bondNum: 1 });
setSeed(12+x, 5+b, { beadType: 202, index: -3, bondNum: 1 });
setSeed(13+x, 5+b, { beadType: 203, index: -3, bondNum: 1 });
setSeed(14+x, 5+b, { beadType: 204, index: -3, bondNum: 1 });
setSeed(15+x, 5+b, { beadType: 205, index: -3, bondNum: 1 });
setSeed(16+x, 5+b, { beadType: 206, index: -3, bondNum: 1 });
setSeed(17+x, 5+b, { beadType: 207, index: -3, bondNum: 1 });
setSeed(10+x, 6+b, { beadType: 100, index: -3, bondNum: 1 });
setSeed(11+x, 7+b, { beadType: 101, index: -3, bondNum: 1 });
setSeed(12+x, 8+b, { beadType: 102, index: -3, bondNum: 1 });
setSeed(9+x, 5+b, { beadType: 0, index: -3, bondNum: 1 });
setSeed(9+x, 6+b, { beadType: 0, index: -3, bondNum: 1 });
setSeed(10+x, 7+b, { beadType: 0, index: -3, bondNum: 1 });
setSeed(11+x, 8+b, { beadType: 0, index: -3, bondNum: 1 });
