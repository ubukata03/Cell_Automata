...
//forMyOS.ruleset::start
    var maxbondnum = 103;

    OSVars.ruleset[3][103]  = true;
    OSVars.ruleset[4][2]  = true;
    OSVars.ruleset[7][3]  = true;
    OSVars.ruleset[7][4]  = true;
    OSVars.ruleset[7][5]  = true;
    OSVars.ruleset[8][6]  = true;
    OSVars.ruleset[9][6]  = true;
    OSVars.ruleset[12][3]  = true;
    OSVars.ruleset[12][103]  = true;

    OSVars.ruleset[10][6]  = true;
    OSVars.ruleset[6][1]  = true;
    OSVars.ruleset[9][4]  = true;
    OSVars.ruleset[3][102]  = true;
    OSVars.ruleset[5][9]  = true;
    OSVars.ruleset[5][2]  = false;
    OSVars.ruleset[4][12]  = true;
    OSVars.ruleset[11][8]  = true;


/*
    OSVars.ruleset[4][102]  = true;
    OSVars.ruleset[11][5]  = true;
    OSVars.ruleset[11][9]  = true;

    OSVars.ruleset[11][7]  = true;
    OSVars.ruleset[10][8]  = true;

    OSVars.ruleset[10][5]  = true;
*/
...
//forMyOS.ruleset::end
   ...
   /*
    for(var j=0;j<=maxbondnum;j++){
    	for(var i=0;i<=maxbondnum;i++){
